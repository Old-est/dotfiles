...
#+begin_src emacs-lisp
  (use-package evil
      ...
      (setq evil-want-C-u-delete t)       ;; Makes C-u delete on insert mode  ;; Adds vim-like C-r redo functionality
      (evil-mode)
      :config
      ...
      (evil-define-key 'normal 'global (kbd "[ c") 'diff-hl-previous-hunk) ;; Previous diff hu
